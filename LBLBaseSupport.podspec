#
#  Be sure to run `pod spec lint LBLBaseSupport.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "李保龙"
  # s.authors            = { "李保龙" => "15837883627@163.com" }
  # s.social_media_url   = "http://twitter.com/李保龙"
